...
router.post('/set-password', (0, validate_1.validate)(auth_1.authValidation.setPassword), auth_1.authController.setPassword);
// router.post('/send-verification-email', auth(), authController.sendVerificationEmail);
// router.post('/resend-verification-token/:email',authController.resendVerificationToken)
...
/**
 * @swagger
 * /auth/resend-verification-token/{email}:
 *   post:
 *     summary: Resend verification email
 *     description: This endpoint resends the verification email to the user.
 *     tags: [Auth]
 *     parameters:
 *       - in: path
 *         name: email
 ...
 *         schema:
 *           type: string
 *         description: The email address of the user who needs the verification email.
 *     responses:
 *       "202":
 ...
 *                 message:
 *                   type: string
 *                   example: Your verification token has been sent to your email!
 *       "401":
 *         $ref: '#/components/responses/Unauthorized'
 */
/**
