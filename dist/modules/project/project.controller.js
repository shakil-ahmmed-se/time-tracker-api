...
exports.getProjects = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const projects = yield ProjectService.getprojects();
    res.status(200).json({ projects });
}));
exports.teamprojects = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const projects = yield ProjectService.teamprojects(req.params.id);
    res.status(200).json({ projects });
}));
