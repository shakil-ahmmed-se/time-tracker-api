...
describe('Error middlewares', () => {
  describe('Error converter', () => {
    ...
    test('should convert an Error without message to ApiError with default message of that http status', () => {
      ...
      error.statusCode = httpStatus.BAD_REQUEST; // This is a valid HttpStatus
      ...
      expect(next).toHaveBeenCalledWith(
        expect.objectContaining({
          statusCode: error.statusCode,
          message: httpStatus[error.statusCode as keyof typeof httpStatus], // Use keyof to access the message safely
          isOperational: false,
        })
      );
    });
